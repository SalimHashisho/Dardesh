...
client_socket.bind(("127.0.0.1", 12000))
...
client_rec.bind(("127.0.0.1", 12000))
client_rec.listen()
...
def send_file():
    ...
    if len(file_address) == 0:
        ...
        client_send.connect(("127.0.0.1", 12001))
...
def send():
    ...
    while True:
        ...
        if can_send and len(ms_queue) != 0:
            ...
            client_socket.sendto(sm, ("127.0.0.1", 12001))
...
def rec():
    ...
    while True:
        ...
        if len(msg) != 1:
            client_socket.sendto(msg[-1].encode(), ("127.0.0.1", 12001))
